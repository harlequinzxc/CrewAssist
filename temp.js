        ...
        function bindTimeInputs(id) {
            document.querySelectorAll('.ifa-time-input, .lma-time-input').forEach(input => {
                ...
                newInp.addEventListener('input', (e) => {
                    ...
                    // Realtime padding & colon injection
                    if (val.length === 3) {
                        // e.g., typing '720' -> '0720' -> '07:20'
                        formatted = '0' + val;
                    ...
                    // Enforce rules on complete times
                    let isValid = false;
            ...
            document.querySelectorAll('.lma-iata-input').forEach(input => {
                ...
                newInp.addEventListener('input', (e) => {
                    ...
                    const idxStr = e.target.id.match(/d+$/)[0];
                    const checkIcon = document.getElementById(id + '-lma-iata-check' + idxStr);
                    const infoText = document.getElementById(id + '-lma-iata-info' + idxStr);
                    ...
                    if (val.length === 3) {
                        ...
                        if (airport) {
                            ...
                            infoText.innerHTML = '<span class="text-green-600 dark:text-green-400">' + airport.city + ', ' + airport.country + '</span>';
                        } else {
                            ...
                            infoText.innerHTML = '<span class="text-red-500">Unknown Station</span>';
                        }
                    } else {
