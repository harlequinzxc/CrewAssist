...
Latest app cache: `crewassist-v51` (`sw.js`). App SemVer: **1.4.18** (`APP_VERSION` in `index.html`, shown on onboarding). Branch work for this line of UI lives on `arena/01a0819d-crewassist`.
...
- **Printer sheet art:** Elegant dining-card is in. Compact still iterating (v1.4.18: tight hang-indent items, Light Bites comma-wrap, broader protein invert). More compact notes still coming.
